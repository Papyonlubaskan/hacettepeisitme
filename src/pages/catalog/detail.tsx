...
export default function CatalogDetailPage() {
  ...
  return (
    <>
      ...
      />
      <SeoBreadcrumbJsonLd items={getBreadcrumbs(path, catalog.brand)} />
      <HearingAidShell title={catalog.title} subtitle={catalog.subtitle}>
        <div className="space-y-8 text-gray-600 leading-relaxed">
          ...
          <div>
            <h2 className="font-serif text-2xl font-bold text-brand-dark mb-6">{catalog.brand} Serileri</h2>
          ...
          <div className="border border-dashed border-brand-accent/40 rounded-2xl p-6 text-center">
            <p className="text-sm text-gray-600 mb-4">
              {catalog.brand} modellerini merkezimizde denemek ve güncel fiyat bilgisi almak için randevu oluşturun.
            </p>
