  ...
  return (
    <>
      <HearingAidShell
        ...
        subtitle="Satışını yaptığımız markaların güncel seri ve modellerini merkezimizde inceleyebilir, uzman danışmanlık alabilirsiniz."
      >
        <div className="space-y-6">
          <p className="text-gray-600 leading-relaxed">
            Aşağıdaki marka katalogları bilgilendirme amaçlıdır. Güncel model listesi, fiyat ve stok durumu için
            merkezimize başvurmanızı öneririz. Tüm katalog modellerinde ücretsiz işitme testi sonrası deneme imkânı
            sunulmaktadır.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {CATALOGS.map((cat) => (
              ...
              >
                <p className="text-sm font-semibold text-brand-accent uppercase tracking-wide mb-2">{cat.brand}</p>
